...
The selected use cases reflect practical interactions in QuizSpark. Students participate in quizzes, join live sessions, submit answers, and track progress. Teachers create and manage quizzes, evaluate question quality, host sessions, manage classes, and analyze performance. AI features support both Students and Teachers by generating questions and recommending personalized quizzes, enabling efficient content creation and adaptive learning.
\begin{figure}[h]
    \centering
...
The purpose of presenting an overall use case diagram at this stage is to offer a visual reference that complements the surrounding textual descriptions. The diagram is not intended to introduce new information, but rather to support the reader’s orientation when navigating the document. By placing the figure alongside the written sections, the document maintains a balance between graphical and textual representations, which is a common practice in software engineering reports.

In formal documentation, figures such as use case diagrams are often accompanied by brief contextual text to ensure continuity in reading flow. This additional text helps prevent abrupt transitions between sections and improves the overall structure and readability of the report, especially when figures occupy a significant portion of the page. As a result, the figure and its surrounding text function together as a cohesive presentation unit rather than as isolated elements.

From a documentation perspective, this approach contributes to a more polished and professional layout, while leaving detailed explanations to subsequent sections where appropriate. The diagram should therefore be understood as a supportive visual element within the overall report structure.
